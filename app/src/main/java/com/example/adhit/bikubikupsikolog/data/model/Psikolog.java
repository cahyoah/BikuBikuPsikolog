...
public class Psikolog {
    ...
    public Psikolog(String id, String username, String email, String token, String kodeSaku, String statusAkun, String nama, String wa, String idLine, String bio, String jnsKel, String alamat, String foto, String statusKabim, String approvalKabim, String idHistoryUser) {
        this.id = id;
